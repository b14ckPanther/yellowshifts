...
class ResetEmployeePasswordDialog extends ConsumerStatefulWidget {
  ...
  static Future<void> show(
    ...
    required EmployeeDetails employee,
  }) {
    return showDialog<void>(
      context: context,
      barrierDismissible: false,
      builder: (ctx) => ResetEmployeePasswordDialog(employee: employee),
    );
  }
...
class _ResetEmployeePasswordDialogState
  ...
  Future<void> _handleSubmit() async {
    ...
    try {
      final newPassword =
          await ref.read(employeeDirectoryProvider.notifier).resetPassword(
  ...
  Widget build(BuildContext context) {
    ...
    return AppDialog(
      ...
      subtitle: l10n.employeeResetPasswordSubtitle(widget.employee.fullName),
      content: Form(
        key: _formKey,
        child: Column(
          mainAxisSize: MainAxisSize.min,
